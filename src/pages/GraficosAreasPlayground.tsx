...
const ejemplosComunicacion: Record<string, ConfiguracionGraficoArea> = {
  estructura_narrativa: {
    ...
    secciones: [
      { nombre: "Inicio", icono: "🌅", color: "#4CAF50", contenido: "En los Andes vivían un zorro astuto y un cóndor sabio. Eran vecinos en la montaña y se encontraban cada mañana." },
      { nombre: "Nudo", icono: "⚡", color: "#FF9800", contenido: "Un día el zorro retó al cóndor a una carrera para demostrar quién era más rápido. El zorro hizo trampa escondiéndose en las plumas del cóndor." },
      { nombre: "Desenlace", icono: "🌟", color: "#2196F3", contenido: "El cóndor descubrió al zorro y lo dejó caer suavemente. El zorro aprendió que la honestidad es más valiosa que ganar." },
    ],
  ...
  organizador_kvl: {
    ...
    columnas: [
      { encabezado: "¿Qué SÉ?", color: "#4CAF50", icono: "💡", items: ["Algunos animales están desapareciendo", "El oso de anteojos vive en los Andes"] },
      { encabezado: "¿Qué QUIERO saber?", color: "#FF9800", icono: "❓", items: ["¿Cuántos animales están en peligro?", "¿Qué podemos hacer para protegerlos?"] },
      { encabezado: "¿Qué APRENDÍ?", color: "#2196F3", icono: "📚", items: [] },
    ],
  } as any,
...
const ejemplosCiencia: Record<string, ConfiguracionGraficoArea> = {
  ...
  ciclo_proceso: {
    ...
    tipo: "circular",
    fases: [
      { nombre: "Evaporación", descripcion: "El agua del mar se calienta y sube como vapor", icono: "☀️", color: "#FF9800" },
      { nombre: "Condensación", descripcion: "El vapor se enfría y forma nubes en la atmósfera", icono: "☁️", color: "#90CAF9" },
      { nombre: "Precipitación", descripcion: "Cae lluvia, granizo o nieve hacia la tierra", icono: "🌧️", color: "#2196F3" },
      { nombre: "Infiltración", descripcion: "El agua penetra el suelo y vuelve a ríos y mares", icono: "🌊", color: "#4CAF50" },
    ],
    colorFondo: "#E3F2FD",
  } as any,
  ciclo_proceso_lineal: {
    ...
    tipo: "lineal",
    fases: [
      { nombre: "Boca", descripcion: "Masticamos y mezclamos con saliva", icono: "👄", color: "#E91E63" },
      { nombre: "Esófago", descripcion: "El bolo alimenticio baja al estómago", icono: "⬇️", color: "#9C27B0" },
      { nombre: "Estómago", descripcion: "Los jugos gástricos descomponen el alimento", icono: "🫧", color: "#FF9800" },
      { nombre: "Intestino delgado", descripcion: "Se absorben los nutrientes", icono: "🔄", color: "#4CAF50" },
      { nombre: "Intestino grueso", descripcion: "Se absorbe el agua y se forman los desechos", icono: "💧", color: "#795548" },
    ],
    colorFondo: "#FFF3E0",
  } as any,
...
const ejemplosPersonalSocial: Record<string, ConfiguracionGraficoArea> = {
  linea_tiempo: {
    ...
    eventos: [
      { fecha: "1438", etiqueta: "Fundación del Tahuantinsuyo", descripcion: "Pachacútec expande el Imperio Inca", color: "#FF9800", icono: "🏛️" },
      { fecha: "1470", etiqueta: "Expansión al norte", descripcion: "El Inca llega hasta Ecuador", color: "#9C27B0", icono: "🗺️" },
      { fecha: "1532", etiqueta: "Llegada de los españoles", descripcion: "Francisco Pizarro llega a Perú", color: "#F44336", icono: "⚔️" },
      { fecha: "1533", etiqueta: "Caída de Atahualpa", descripcion: "Fin del Imperio Inca", color: "#795548", icono: "📜" },
    ],
    colorLinea: "#795548",
    mostrarDecadas: true,
  } as any,
  linea_tiempo_vertical: {
    ...
    eventos: [
      { fecha: "2017", etiqueta: "Nací", descripcion: "Llegué al mundo en Lima", color: "#E91E63", icono: "👶" },
      { fecha: "2020", etiqueta: "Primer día de inicial", descripcion: "Conocí a mis primeros amigos", color: "#4CAF50", icono: "🏫" },
      { fecha: "2023", etiqueta: "Entré a primaria", descripcion: "Empecé a leer y escribir", color: "#2196F3", icono: "📖" },
      { fecha: "2026", etiqueta: "Tercer grado", descripcion: "Aprendo sobre la historia del Perú", color: "#FF9800", icono: "🇵🇪" },
    ],
    colorLinea: "#607D8B",
  } as any,
  cuadro_comparativo: {
    ...
    columnas: [
      { nombre: "Tahuantinsuyo", color: "#4CAF50", valores: ["Sapa Inca / curacas", "Mita / redistribución", "Politeísta (Inti)", "Caminos, templos"] },
      { nombre: "Virreinato", color: "#2196F3", valores: ["Rey / Virrey / Cabildo", "Tributo / minería", "Católica", "Catedrales, palacios"] },
    ],
  ...
  rueda_emociones: {
    ...
    emociones: [
      { nombre: "Alegría", color: "#FFEB3B", icono: "😊", descripcion: "Me siento contento y con energía" },
      { nombre: "Tristeza", color: "#90CAF9", icono: "😢", descripcion: "Me siento con ganas de llorar" },
      { nombre: "Miedo", color: "#CE93D8", icono: "😨", descripcion: "Siento que algo malo puede pasar" },
      { nombre: "Enojo", color: "#EF9A9A", icono: "😠", descripcion: "Algo me molesta mucho" },
      { nombre: "Sorpresa", color: "#A5D6A7", icono: "😲", descripcion: "Algo me tomó por sorpresa" },
      { nombre: "Calma", color: "#80DEEA", icono: "😌", descripcion: "Me siento tranquilo y relajado" },
    ],
...
const ejemplosArte: Record<string, ConfiguracionGraficoArea> = {
  ...
  ficha_proceso_creativo: {
    ...
    etapas: [
      { nombre: "Exploración", icono: "🔍", color: "#4CAF50", descripcion: "¿Qué quiero crear? Un móvil con animales en peligro de extinción del Perú." },
      { nombre: "Materiales", icono: "🎨", color: "#FF9800", descripcion: "¿Qué necesito?", lista: ["Cartulina de colores", "Tijeras", "Hilo o pabilo", "Plumones", "Perforadora"] },
      { nombre: "Creación", icono: "✏️", color: "#2196F3", descripcion: "Paso a paso:", pasos: ["Dibujar el animal elegido en la cartulina", "Recortar el contorno con cuidado", "Colorear con los plumones", "Perforar y pasar el hilo para colgar"] },
      { nombre: "Presentación", icono: "🌟", color: "#9C27B0", descripcion: "Explicaré mi animal al grupo y contaré por qué lo elegí." },
    ],
  } as any,
};
...
const ejemplosEdFisica: Record<string, ConfiguracionGraficoArea> = {
  ...
  tabla_habitos: {
    ...
    habitos: [
      { nombre: "Tomé agua (8 vasos)", icono: "💧", color: "#03A9F4" },
      { nombre: "Comí frutas y verduras", icono: "🥗", color: "#4CAF50" },
      { nombre: "Hice actividad física (30 min)", icono: "🏃", color: "#FF9800" },
      { nombre: "Dormí 8 horas", icono: "😴", color: "#9C27B0" },
      { nombre: "Me cepillé los dientes", icono: "🦷", color: "#00BCD4" },
    ],
...
const areas: AreaInfo[] = [
  { nombre: "Comunicación", icono: "📖", color: "#2196F3", ejemplos: ejemplosComunicacion },
  { nombre: "Ciencia y Tecnología", icono: "🔬", color: "#4CAF50", ejemplos: ejemplosCiencia },
  { nombre: "Personal Social", icono: "🌎", color: "#FF9800", ejemplos: ejemplosPersonalSocial },
  { nombre: "Educación Religiosa", icono: "🕊️", color: "#7B1FA2", ejemplos: ejemplosReligion },
  { nombre: "Arte y Cultura", icono: "🎨", color: "#E91E63", ejemplos: ejemplosArte },
  { nombre: "Educación Física", icono: "🏃", color: "#009688", ejemplos: ejemplosEdFisica },
];
